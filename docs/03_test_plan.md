...
the TypeScript stack). Built so far (increments 1–3) and **green** (`tests/domain/*`): R-1, R-3, R-13, R-19, R-30, R-31, R-32,
R-33, INV-2, INV-4, INV-12, INV-14, E-6, E-15, E-24. Every other behavior is a Vitest `todo` in
