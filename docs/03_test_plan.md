...
the TypeScript stack). Built so far (increments 1–4) and **green** (`tests/domain/*`): R-1, R-3, R-13, R-19, R-30, R-31, R-32,
R-33, INV-2, INV-4, INV-12, INV-14, INV-15, INV-16, E-6, E-15, E-24, E-25, E-26, E-27. Sentiment (R-15) and
emotion (R-46) have their aggregation cores + classifier seams built; live detection wires in with the LLM gateway. Every other behavior is a Vitest `todo` in
