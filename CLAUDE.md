...
- **Phase 1 (SPECIFY) at Requirements v5 — ready for approval.** v2 = unified-customer view + competitors +
  lawful collection + Brand Love + data model; v3 = Brand Trust; v4 = all 15 §14 decisions resolved +
  "Ambiguity" → "Ambivalence"; **v5 = Closed-Loop / Service Recovery pillar** — opt-in contact (I-10),
  triggers (R-35), RecoveryCase (R-36, data model), integrations/hand-off (R-37), recovery measurement
  (R-38, O-15), reinforcement plays (R-39), prioritization (R-40); INV-13 consent-gated; DPS-10. Posture
  **#2 (orchestrate + measure), architected for #3 (native workflow)** — RecoveryCase owned internally so
  #3 is an evolution, not a rewrite. Grounded in the service-recovery paradox (D-16).
...
- **Next action:** Paul approves v4 → Phase 2 CHALLENGE → Requirements v5.
